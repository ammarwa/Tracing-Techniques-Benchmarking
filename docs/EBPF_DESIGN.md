...
- **Fixed ~5 us Overhead**: Not suitable for sub-microsecond functions
- **BPF Complexity**: Requires BPF toolchain (clang, bpftool, libbpf)
- **Kernel Dependency**: Requires kernel 5.8+ for best features

For a userspace alternative that eliminates kernel context switches, see [bpftime Design Documentation](BPFTIME_DESIGN.md).
